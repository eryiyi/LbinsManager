...
--收货地址表
CREATE TABLE paopao_shopping_address(
  address_id char(32) PRIMARY  KEY ,
  emp_id char(32) NOT NULL ,
  accept_name varchar2(32) NOT NULL ,
  province VARCHAR(50),
  city VARCHAR(50),
  area VARCHAR(50),
  address varchar2(500) NOT NULL ,
...
--卖家宝贝表
CREATE TABLE paopao_goods(
  goods_id char(32) PRIMARY KEY,
  goods_type_id char(32) NOT NULL ,
  goods_name VARCHAR2 (200) NOT NULL ,
  goods_cover VARCHAR2 (200) NOT NULL ,
  goods_cont clob NOT NULL ,
  sell_price VARCHAR2 (50) NOT NULL ,
  market_price VARCHAR2 (50),
  goods_address VARCHAR2 (300),
  goods_person VARCHAR2(100),
   goods_tel VARCHAR2 (20),
   goods_qq varchar2(20),
   goods_emp_id char(32) NOT NULL ,
   goods_school_id NUMBER (20) NOT NULL ,
   goods_is_use char(1) DEFAULT '0' NOT NULL ,
   goods_is_del char(1) DEFAULT '0' NOT NULL ,
   up_time VARCHAR2 (100) NOT NULL ,
   goods_count VARCHAR2 (20)
);

--订单表
CREATE TABLE paopao_shopping_order(
  order_no char(32) PRIMARY KEY ,
  goods_id CHAR (32) NOT NULL ,
  emp_id CHAR (32) NOT NULL ,
  seller_emp_id CHAR (32) NOT NULL ,
  provinceId VARCHAR2(50) NOT NULL ,
  cityId VARCHAR2(50) NOT NULL ,
  areaId VARCHAR2(50) NOT NULL ,
  address_id char(32) NOT NULL ,
  goods_count VARCHAR (10) NOT NULL ,
  payable_amount FLOAT NOT NULL ,
  create_time varchar2(100) NOT NULL ,
  pay_time VARCHAR2(100),
  send_time VARCHAR2(100),
  accept_time VARCHAR2(100),
  completion_time varchar(100),
  status char(1) DEFAULT '1' ,
  pay_status char(1) DEFAULT '0',
  distribution_type char(1) DEFAULT '0' ,
  distribution_status char(1) DEFAULT '0' ,
  ...
  isAccount CHAR(1) DEFAULT '0'
);

--宝贝收藏表
CREATE TABLE goods_favour(
  favour_id CHAR (32) PRIMARY KEY ,
  goods_id char(32) NOT NULL ,
  emp_id_favour CHAR (32) NOT NULL ,
  emp_id_goods CHAR (32) NOT NULL ,
  dateline VARCHAR (100)
);
--订单表  和支付宝进行关联
CREATE TABLE Paopao_ShoppingTrade(
  out_trade_no CHAR (32) PRIMARY KEY ,
  trade_prices VARCHAR2(50) NOT NULL ,
  pay_status CHAR(1) DEFAULT '0' NOT NULL,
  dateline VARCHAR (100),
  SCHOOLID NUMBER(5) NOT NULL
);
...
----取消订单—记录表—卖家操作时记录该表
CREATE TABLE Paopao_shopping_cancel(
  order_cancel_no CHAR(32) PRIMARY KEY ,
...
--商城轮播表
CREATE TABLE paopao_viewpager(
  id char(32) PRIMARY KEY ,
  pic_address VARCHAR2(300) NOT NULL ,
  pic_url varchar2(300) NOT NULL ,
  pic_desc varchar2(500),
  school_id number(5),
  goods_id char(32),
  view_type char(1)
);
...
CREATE TABLE manager_info(
  info_id char(32) PRIMARY KEY ,
  manager_id char(32) NOT NULL ,
  real_name varchar2(100) NOT NULL ,--真实姓名
  idcard varchar2(50) NOT NULL ,--身份证号
  idcard_url varchar2(100) NOT NULL , --身份证照片正面
  pay_number varchar2(100) NOT NULL ,--支付宝账号
  check_name VARCHAR2(100) NOT NULL, -- 支付宝校验姓名
  bank_card varchar2(100) NOT NULL ,
  bank_type varchar2(100) NOT NULL ,--所属银行
  bank_address varchar2(300) NOT NULL ,--开户行地址
  bank_name varchar2(100) NOT NULL ,--开户人姓名
  mobile VARCHAR2(20) NOT NULL --联系电话
);