    ...
    <div class="box ui-draggable ui-droppable">
      ...
      <div class="box-content">
        <form class="form-inline">
          <div class="col-sm-2">
            <input type="text" id="start_time" value="${query.startTime}" class="form-control" placeholder="开始时间">
            <span class="fa fa-calendar txt-danger form-control-feedback"></span>
          </div>
          <div class="col-sm-2">
            <input type="text" id="end_time" value="${query.endTime}" class="form-control" placeholder="结束时间">
            <span class="fa fa-calendar txt-danger form-control-feedback"></span>
          </div>
