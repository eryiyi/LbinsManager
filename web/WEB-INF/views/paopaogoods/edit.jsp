      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="goods_title" class="form-control" value="${goods.name}" placeholder="商品名字" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="goods_seller_price" value="${goods.sellPrice}" class="form-control" placeholder="销售价格" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">市场价格</label>
            <div class="col-sm-4">
              <input type="text" id="goods_market_price" value="${goods.marketPrice}" class="form-control" placeholder="市场价格" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">宝贝地址</label>
            <div class="col-sm-4">
              <input type="text" id="goods_address" value="${goods.address}" class="form-control" placeholder="宝贝地址" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">联系人</label>
            <div class="col-sm-4">
              <input type="text" id="goods_person" value="${goods.person}" class="form-control" placeholder="联系人" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">电话</label>
            <div class="col-sm-4">
              <input type="text" id="goods_tel" value="${goods.tel}" class="form-control" placeholder="电话" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">QQ</label>
            <div class="col-sm-4">
              <input type="text" id="goods_qq" value="${goods.qq}" class="form-control" placeholder="qq" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">宝贝数量</label>
            <div class="col-sm-4">
              <input type="text" id="goods_count" value="${goods.count}" class="form-control" placeholder="宝贝数量" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <script id="editor" name="editor" type="text/plain" style="width:100%;height:250px;">${goods.cont}</script>
            </div>
          </div>
