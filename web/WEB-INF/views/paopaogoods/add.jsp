      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="goods_count" class="form-control" placeholder="宝贝数量" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function savePaopaoGoods() {
    ...
    $.ajax({
      ...
      data:{"name":goodsTitle, "typeId":type,"cover":imagePath, "sellPrice":sellerPrice, "marketPrice":marketPrice, "address":address, "person":person,"tel":tel, "qq":qq, "count":count, "cont":content,"schools":schools},
      async: false,
