      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text"  id="paopao_title"  class="form-control" placeholder="视频标题" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">视频内容</label>
            <div class="col-sm-8">
              <textarea id="paopao_content" class="form-control" placeholder="视频内容" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <br/><br/><div id="imageDiv" style="padding: 10px"></div>
            </div>
          </div>
