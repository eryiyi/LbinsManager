...
<div class="row">
  <div id="breadcrumb" class="col-xs-12">
    ...
    <ol class="breadcrumb pull-left">
      ...
      <li><a href="#">承包商管理</a></li>
      <li><a href="#">承包商列表</a></li>
    </ol>
        ...
        <table class="table">
          ...
          <c:forEach items="${list}" var="e" varStatus="st">
            <tr>
              ...
              <td>
                <button class="btn btn-primary" type="button" onclick="changeContract('${e.empId}')">设置</button>
                <button class="btn btn-primary" type="button" onclick="selectPermission('${e.empId}')">分配权限</button>
              </td>
            </tr>
          </c:forEach>
          </tbody>
...
<script type="text/javascript">
  function searchIndex(e){
    ...
    if(_index <= ${page.pageCount} && _index >= 1){
        window.location.href="#module=listContracts&page="+_index+"&size="+size;
    }else{
  ...
  function nextPage(_page) {
    ...
    if ((page <= ${page.pageCount} && page >= 1)) {
        window.location.href="#module=listContracts&page="+page+"&size="+size;
    } else {
      alert("请输入1-${page.pageCount}的页码数");
    }
  }
