      ...
      <div class="box-content">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="populate placeholder"  id="viewpager_type" onchange="selectType()">
                ...
                <c:if test="${sessionScope.account.type=='2'}"><option value="1">PK活动</option></c:if>
                <c:if test="${sessionScope.account.type=='2'}"> <option value="2">商品详情</option></c:if>
                <c:if test="${sessionScope.account.type=='1'}"><option value="3">广告</option> </c:if>
              </select>
            </div>
          </div>
            </c:if>
        <c:if test="${sessionScope.account.type=='2' }">
          ...
          <div class="form-group" style="display: none" id="pic_url_div">
            ...
            <div class="col-sm-6">
              <input type="text" id="ad_net" class="form-control" placeholder="图片链接" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea id="viewpager_desc" class="form-control" rows="3" placeholder="轮播介绍..."></textarea>
            </div>
          </div>
