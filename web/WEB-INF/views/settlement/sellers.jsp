    ...
    <div class="box ui-draggable ui-droppable">
      ...
      <div class="box-content">
        <form class="form-inline">
          <div class="col-sm-2">
            <input type="text" id="search_date" value="${query.date}" class="form-control" placeholder="查询日期">
            <span class="fa fa-calendar txt-danger form-control-feedback"></span>
          </div>
          <button type="submit" onclick="clearSearch()" class="btn btn-default btn-sm">清空</button>
          <button type="submit" onclick="searchSettlementSellers('1')" class="btn btn-default btn-sm">查找</button>
        </form>
        ...
        <table class="table">
          ...
          <c:forEach items="${list}" var="e" varStatus="st">
            <tr>
              ...
              <td>
                <a class="btn btn-default btn-sm" href="#module=/settlement/orders&date=${query.date}&empId=${e.empId}" role="button">订单列表</a>
                <a class="btn btn-default btn-sm" href="#module=/settlement/endOrder&date=${query.date}&empId=${e.empId}" role="button">去结算</a>
              </td>
            </tr>
          </c:forEach>
          </tbody>
